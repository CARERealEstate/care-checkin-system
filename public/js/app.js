    ...
    if (!data.bookings || data.bookings.length === 0) {
      list.innerHTML = `
        <div style="text-align:center;padding:40px;color:#718096;">
          ...
          <p style="font-size:13px;margin-top:8px;">Sync from CRM to load your placements</p>
          <button class="btn btn-primary" style="margin-top:12px;" onclick="syncCRM()"><i class="fas fa-sync-alt"></i> Sync from CRM</button>
        </div>`;
      return;
    }
    ...
    list.innerHTML = data.bookings.map(b => `
      <div class="booking-card" onclick="viewBooking(${b.id})">
        ...
        <div class="bc-actions">
          ...
          ${b.sangam_id ? '<a class="btn btn-sm btn-outline" href="https://care.sangamcrm.com/leads/'+b.sangam_id+'" target="_blank" onclick="event.stopPropagation()" title="View in CRM"><i class="fas fa-external-link-alt"></i></a>' : ''}
    ...
    container.innerHTML = `
      <div class="detail-header">
        ...
        <div style="display:flex;gap:8px;">
          ...
          ${b.sangam_id ? `<a class="btn btn-outline" href="https://care.sangamcrm.com/leads/${b.sangam_id}" target="_blank"><i class="fas fa-external-link-alt"></i> View in CRM</a>` : ''}
...
// ============= ACTIONS =============
// Manual booking creation removed - bookings come from CRM sync
